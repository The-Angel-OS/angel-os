...
export function TenantChooser({ className = "", userId }: TenantChooserProps) {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'setup': return 'bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-400'
                ...
                {filteredTenants.map((tenant) => (
                  ...
                  >
                    <div className="flex items-center gap-4 w-full">
                      <div className="w-10 h-10 bg-gradient-to-r from-primary/80 to-primary rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm">
